...
export function generateEmptyReleasesSummaryTsContent(sokoDirectory: string) {
...
export function generateEmptyReleasesSummaryJsonContent(sokoDirectory: string) {
  return {
    sokoDirectory,
    contracts: {},
    releases: {},
